...
class ParseyyStackEntry {
  public int $stateno = 0;       /* The state-number */
  public int $major = 0;         /* The major token value.  This is the code
                     ** number for the token at this stack level */
  public mixed $minor = null; /* The user-supplied minor token value.  This
...
** None.
*/
public function ParseTrace(mixed $TraceFILE, ?string $zTracePrompt): void {
...
** value.
*/
public function ParseTokenName(int $tokenType): string {
